...
import com.javamajor.backend.Entity.SessionStart;
...
public class QuestionsController {
    ...
    public ResponseEntity<SessionStart> getQuestions(@PathVariable String username){
        User user = userService.getUser(username);
        SessionStart s = new SessionStart(questionsService.getQuestion(user),sessionService.saveSession(user));
